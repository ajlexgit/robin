...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, primary_key=True, auto_created=True)),
                ('old_path', models.CharField(verbose_name='redirect from', unique=True, max_length=200, help_text="This should be an absolute path, excluding the domain name. Example: '/events/search/'.")),
                ('new_path', models.CharField(verbose_name='redirect to', blank=True, max_length=200, help_text="This can be either an absolute path (as above) or a full URL starting with 'http://'.")),
                ...
                ('created', models.DateField(verbose_name='created', editable=False, default=django.utils.timezone.now)),
            ],
            options={
