    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Required. 30 characters or fewer. Letters, digits and @/./+/-/_ only.', max_length=30, unique=True, verbose_name='username', validators=[django.core.validators.RegexValidator('^[\\w.@+-]+$', 'Enter a valid username.', 'invalid')])),
                ...
                ('avatar', libs.stdimage.fields.StdImageField(verbose_name='avatar', blank=True, variations={'small': {'size': (50, 50)}, 'micro': {'size': (32, 32)}, 'normal': {'size': (150, 150)}}, min_dimensions=(150, 150), aspects='normal', storage=libs.media_storage.MediaStorage('users/avatar'), upload_to='')),
