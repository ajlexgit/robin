    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', libs.stdimage.fields.StdImageField(aspects='normal', min_dimensions=(150, 150), variations={'small': {'size': (50, 50)}, 'micro': {'size': (32, 32)}, 'normal': {'size': (150, 150)}}, blank=True, storage=libs.media_storage.MediaStorage('users/avatar'), verbose_name='avatar', upload_to='')),
