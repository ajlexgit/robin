    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', libs.stdimage.fields.StdImageField(blank=True, storage=libs.media_storage.MediaStorage('users/avatar'), aspects='normal', variations={'small': {'size': (50, 50)}, 'normal': {'size': (150, 150)}, 'micro': {'size': (32, 32)}}, verbose_name='avatar', min_dimensions=(150, 150), upload_to='')),
                ('avatar_crop', models.CharField(blank=True, max_length=32, verbose_name='avatar crop coordinates')),
                ('groups', models.ManyToManyField(blank=True, related_name='user_set', to='auth.Group', related_query_name='user', verbose_name='groups', help_text='The groups this user belongs to. A user will get all permissions granted to each of his/her group.')),
