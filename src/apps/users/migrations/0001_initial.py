    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', libs.stdimage.fields.StdImageField(aspects='normal', verbose_name='avatar', upload_to='', blank=True, storage=libs.media_storage.MediaStorage('users/avatar'), min_dimensions=(150, 150), variations={'normal': {'size': (150, 150)}, 'small': {'size': (50, 50)}, 'micro': {'size': (32, 32)}})),
                ('avatar_crop', models.CharField(verbose_name='avatar crop coordinates', blank=True, max_length=32)),
                ('groups', models.ManyToManyField(related_query_name='user', verbose_name='groups', related_name='user_set', blank=True, to='auth.Group', help_text='The groups this user belongs to. A user will get all permissions granted to each of his/her group.')),
