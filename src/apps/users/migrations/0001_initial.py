    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', libs.stdimage.fields.StdImageField(min_dimensions=(150, 150), variations={'normal': {'size': (150, 150)}, 'micro': {'size': (32, 32)}, 'small': {'size': (50, 50)}}, aspects='normal', blank=True, storage=libs.media_storage.MediaStorage('users/avatar'), upload_to='', verbose_name='avatar')),
