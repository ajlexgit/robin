    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', libs.stdimage.fields.StdImageField(verbose_name='avatar', variations={'micro': {'size': (32, 32)}, 'normal': {'size': (150, 150)}, 'small': {'size': (50, 50)}}, upload_to='', blank=True, storage=libs.media_storage.MediaStorage('users/avatar'), min_dimensions=(150, 150), aspects='normal')),
                ('avatar_crop', models.CharField(verbose_name='avatar crop coordinates', max_length=32, blank=True)),
                ('groups', models.ManyToManyField(verbose_name='groups', blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of his/her group.', related_query_name='user', related_name='user_set', to='auth.Group')),
