    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', libs.stdimage.fields.StdImageField(blank=True, upload_to='', aspects='normal', variations={'normal': {'size': (150, 150)}, 'small': {'size': (50, 50)}, 'micro': {'size': (32, 32)}}, min_dimensions=(150, 150), verbose_name='avatar', storage=libs.storages.media_storage.MediaStorage('users/avatar'))),
