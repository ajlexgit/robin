...
from .fields import VariationImageFieldFile, VariationImageField, crop_field_name
...
__all__ = ['VariationImageFieldFile', 'VariationImageField', 'CropArea', 'crop_field_name',
